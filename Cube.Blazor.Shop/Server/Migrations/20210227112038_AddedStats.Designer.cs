...
namespace Cube.Blazor.Shop.Server.Migrations
{
    ...
    [Migration("20210227112038_AddedStats")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.Edition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.Stats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.ProductVariant", b =>
                {
                    b.HasOne("Cube.Blazor.Shop.Shared.Models.Edition", "Edition")
                        .WithMany()
                        .HasForeignKey("EditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cube.Blazor.Shop.Shared.Models.Product", "Product")
                        .WithMany("Variants")
