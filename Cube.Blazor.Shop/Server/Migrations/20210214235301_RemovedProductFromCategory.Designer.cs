...
namespace Cube.Blazor.Shop.Server.Migrations
{
    ...
    [Migration("20210214235301_RemovedProductFromCategory")]
    partial class RemovedProductFromCategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 158, DateTimeKind.Local).AddTicks(6083),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8538),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8647),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8653),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8657),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8676),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8680),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8874),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 2, 15, 0, 53, 1, 164, DateTimeKind.Local).AddTicks(8880),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Cube.Blazor.Shop.Shared.Models.Product", b =>
                {
                    b.HasOne("Cube.Blazor.Shop.Shared.Models.Category", "Category")
                        .WithMany()
