...
namespace Cube.Blazor.Shop.Server.Migrations
{
    ...
    [Migration("20210215095835_AddedEditionSeeding")]
    partial class AddedEditionSeeding
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EditionProduct", b =>
                {
                    b.HasOne("Cube.Blazor.Shop.Shared.Models.Edition", null)
                        .WithMany()
                        .HasForeignKey("EditionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cube.Blazor.Shop.Shared.Models.Product", null)
                        .WithMany()
